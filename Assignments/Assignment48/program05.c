// Display Elements at Odd Position
...
/*
    Algorithm
        Start
            ...
            and 
            Display the Element which is on Even Position. 
        Stop
*/
...
//  Description :   Display the all values which on Odd Position               //
//  Input   :       int                                                        //
//  Output  :       void                                                       //
//  Author  :       Rutvik Bibhishan Kamble                                    //
//  Date    :       04/01/2026                                                 //
...
void DisplayOddPosition(PNODE first)
{
    ...
    printf("Values which on Even Positon :\t\t");

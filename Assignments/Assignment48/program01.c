...
/*
    Algorithm
        Start
            ...
            and 
            Replace the Even numbers with 0 from the LL. 
        Stop
*/
...
/////////////////////////////////////////////////////////////////////////////////
//                                                                             //
//  Function Name : ReplaceEvne                                                //
//  Description :   Replace Even number with 0 from the LL                     //
//  Input   :       int                                                        //
//  Output  :       void                                                       //
//  Author  :       Rutvik Bibhishan Kamble                                    //
//  Date    :       04/01/2026                                                 //
...
void ReplaceEven(PNODE first)
{
    ...
    printf("Replaced Even numbers with 0 :\n");
    Display(first);
}

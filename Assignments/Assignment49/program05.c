...
/////////////////////////////////////////////////////////////////////////////////
//                                                                             //
//  Function Name : CountTowDigit                                              //
//  Description :   Count all Tow-Digit numbers                                //
//  Input   :       int                                                        //
//  Output  :       int                                                        //
//  Author  :       Rutvik Bibhishan Kamble                                    //
//  Date    :       04/01/2026                                                 //
...
int main()
{
    ...
    Display(head);
    iRet = CountTowDigit(head);

    printf("There are %d Two-Digit numbers available in the LL.",iRet);

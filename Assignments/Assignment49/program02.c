// Check Whether All ElementsAre Positive
...
/*
    Algorithm
        Start
            ...
            and 
            Check all Elements are Positive or not. 
        Stop
*/
...
//  Description :   Check All Element Positive or not                          //
//  Input   :       int                                                        //
//  Output  :       void                                                       //
//  Author  :       Rutvik Bibhishan Kamble                                    //
//  Date    :       04/01/2026                                                 //
...
BOOL CheckAllPositive(PNODE first, int no)
{
    PNODE temp = NULL;
    int Count = 0;
...
int main()
{
    ...
    Display(head);
    iRet = CheckAllPositive(head,iValue);

    if(iRet == 1)
    {
        printf("Yes, The all elements from Linked List are Positive.");
    }
    else
    {
        printf("No, The LL does not contain all element Positive.");
    }
    return 0;
}

...
/////////////////////////////////////////////////////////////////////////////////
//                                                                             //
//  Function Name : DifferenceMinMax                                           //
//  Description :   Display the Difference Min value adn Max Value             //
//  Input   :       int                                                        //
//  Output  :       void                                                       //
//  Author  :       Rutvik Bibhishan Kamble                                    //
//  Date    :       04/01/2026                                                 //
...
int DifferenceMinMax(PNODE first)
{
    PNODE temp = NULL;
    int Count = 0, iMin = 0, iMax = 0;
...
int main()
{
    ...
    Display(head);
    iRet = DifferenceMinMax(head);

    printf("Difference between the Min and Max Value from the LL : %d",iRet);

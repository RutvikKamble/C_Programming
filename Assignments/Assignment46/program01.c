...
//  Description :   Display the numbers greter than the X                      //
//  Input   :       int                                                       //
//  Output  :       int                                                        //
//  Author  :       Rutvik Bibhishan Kamble                                    //
//  Date    :       30/12/2025                                                 //
...
void DisplayLarge(PNODE first, int X)
{
    if(first == NULL)
    {
        printf("The linked list is not contain the node");
    }
    else
    {
        printf("The numbers which are greter than %d\n",X);
        while(first != NULL)
        {
        if(first->Data > X)
        {

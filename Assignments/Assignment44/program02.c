//  Count node containing even value
...
/*
    Algorithm
        Start
            ...
            and
            Check from that the total Even values 
        Stop
*/
...
/////////////////////////////////////////////////////////////////////////////////
//                                                                             //
//  Function Name : CountEvne                                                  //
//  Description :   Count the all Even elements from the LL                    //
//  Input   :       int*                                                       //
//  Output  :       int                                                        //
//  Author  :       Rutvik Bibhishan Kamble                                    //
//  Date    :       30/12/2025                                                 //
...
int main()
{
    ...
    printf("The total %d Even numbers in LL.",iRet);

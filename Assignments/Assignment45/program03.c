//  Display Last occurance of number in LL
...
//  Description :   Find the last occurance of the first number                //
//  Input   :       int*                                                       //
//  Output  :       int                                                        //
//  Author  :       Rutvik Bibhishan Kamble                                    //
//  Date    :       30/12/2025                                                 //
...
int main()
{
    ...
    {
        printf("The Last occurance of the given number is : %d",iRet);
    }

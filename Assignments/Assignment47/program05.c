// Count prime number from Linked List
...
/*
    Algorithm
        Start
            ...
            and 
            Count Prime number from that numbers. 
        Stop
*/
...
//  Description :   Count the prime numbers from the LL                        //
//  Input   :       int                                                        //
//  Output  :       void                                                       //
//  Author  :       Rutvik Bibhishan Kamble                                    //
//  Date    :       03/01/2026                                                 //
...
int main()
{
    ...
    printf("The total prime number are : %d ",iRet);
